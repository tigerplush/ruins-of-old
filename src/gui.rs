...
use crate::{components::{CombatStats, Player, Name, Position, InBackpack}, gamelog::GameLog, map::Map, State};
...
pub fn show_inventory(gs: &mut State, ctx: &mut Rltk) -> (ItemMenuResult, Option<Entity>) {
    ...
    ctx.draw_box(15, y - 2, 31, count + 3, RGB::named(rltk::WHITE), RGB::named(rltk::WHITE));
